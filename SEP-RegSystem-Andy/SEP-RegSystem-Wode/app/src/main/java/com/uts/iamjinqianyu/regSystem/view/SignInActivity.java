...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        survey.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent intent = new Intent(SignInActivity.this, Q1Activity.class);
                startActivity(intent);
            }
        });
                        ...
                        if (task.isSuccessful()) {
                            ...
                            ValueEventListener userListener = new ValueEventListener() {
                                ...
                                public void onCancelled(DatabaseError databaseError) {
                                    ...
                                    // [START_EXCLUDE]
                                    Toast.makeText(SignInActivity.this, "Failed to load post.",
                            ...
                            Toast.makeText(SignInActivity.this, "Authentication succeed.",
                                    Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SignInActivity.this, "New account created.",
                                    Toast.LENGTH_SHORT).show();
    ...
    /*private void updateInformation(){
        ...
        Toast.makeText(SignInActivity.this, "Updated.",
                Toast.LENGTH_SHORT).show();
    }*/
